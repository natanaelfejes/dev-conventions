...
- **The collection has been wrong** and keeps a numbered list of its own errors, thirty of
...
- **It has been checked from outside nine times, and run once**, between 2026-09-03 and 2026-09-09, and every one
  ...
  **And worst, the eighth, which was the first to look at the installed copy rather than the
  ...
  the end of `EVIDENCE.md`. **Please be the eleventh**: the rate at which checking finds things has not
  slowed.
